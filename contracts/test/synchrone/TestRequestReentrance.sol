...
contract RequestEthereumWeak {
    ...
    function createRequestAsPayee(address _payer, uint _amountExpected, address _extension, bytes32[9] _extensionParams, string _details) public returns(bytes32);
