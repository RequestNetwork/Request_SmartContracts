...
contract('RequestCore', function(accounts) {
	...
	var amount1 = 800000000000000000;
	var amount2 = 9999;
	...
	var gasConsumption = 0;
		...
		// }).then(function() {
		  ...
		  // return requestBitcoin.createRequest(buyer1, amount1, extensions, params[0], params[1], addressBitcoinPayee, addressBitcoinPayer, {from:seller1});11
		}).then(function(res) { 
		...
		// }).then(function(res) { 
		  ...
		  gasConsumption += res.receipt.gasUsed;
		  return requestEthereum.pay(1, {from:buyer1, value:amount1/2});
		}).then(function(res) { 
		  gasConsumption += res.receipt.gasUsed;
		  return requestEthereum.pay(1, {from:buyer1, value:amount1/2});
		}).then(function(res) { 
